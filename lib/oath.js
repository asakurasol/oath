...
Deferred.prototype.resolve = function (data) {
  ...
  this.promise.onSuccess.forEach(function(func){
    func(data);
  });
};
...
Deferred.prototype.reject = function (error) {
  ...
  this.promise.onFailure.forEach(function(func){
    func(error);
  });
};
...
var defer = function () {
  var promise = new Promise(null, null);
  var deferredObject = new Deferred(promise);
